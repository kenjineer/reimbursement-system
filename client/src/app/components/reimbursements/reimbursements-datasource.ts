 ...
 */
export class ReimbursementsDataSource extends DataSource<ReimbursementsItem> {
  data: ReimbursementsItem[];
  paginator: MatPaginator;
  sort: MatSort;

  constructor(displayData: ReimbursementsItem[]) {
    super();
   ...
   */
  connect(): Observable<ReimbursementsItem[]> {
   ...
   */
  private getPagedData(data: ReimbursementsItem[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: ReimbursementsItem[]) {
